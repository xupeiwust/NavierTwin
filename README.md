...
- FastAPI REST 서버 (`/health`, `/preflight`, `/reduce`, `/reduce/pod`, `/twin/build`, `/twin/predict`, `/twin/benchmark`, `/twin/package`, `/twin/package/inspect`, `/twin/package/verify`, `/twin/package/accept`, `/analytic/*`, `/simulate/lbm_cavity`, `/optimize/bayesian`)
