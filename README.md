...
- 고객 지원 번들에 acceptance 산출물과 읽기용 README.txt 첨부: `naviertwin support-bundle --outdir /tmp/naviertwin-support --acceptance-json /tmp/naviertwin-acceptance.json --acceptance-summary /tmp/naviertwin-acceptance.md --zip`
